...
csi3to2 = [];
for i = 1:size(bf1,2)
    if isequal(bf1{i}.addr2, address2)
        timestamps1to2 = [timestamps1to2; bf1{i}.timestamp_low];
        csi1to2 = [csi1to2; bf1{i}.csi(:,:,:)];
    elseif isequal(bf1{i}.addr2, address3)
        timestamps1to3 = [timestamps1to3; bf1{i}.timestamp_low];
        csi1to3 = [csi1to3; bf1{i}.csi(:,:,:)];
    end
end
for i = 1:size(bf2, 2)
    if isequal(bf2{i}.addr2, address3)
        timestamps2to3 = [timestamps2to3; bf2{i}.timestamp_low];
        csi2to3 = [csi2to3; bf2{i}.csi(:,:,:)];
    elseif isequal(bf2{i}.addr2, address1)
        timestamps2to1 = [timestamps2to1; bf2{i}.timestamp_low];
        csi2to1 = [csi2to1; bf2{i}.csi(:,:,:)];
    end
end
for i = 1:size(bf3, 2)
    if isequal(bf3{i}.addr2, address1)
        timestamps3to1 = [timestamps3to1; bf3{i}.timestamp_low];
        csi3to1 = [csi3to1; bf3{i}.csi(:,:,:)];
    elseif isequal(bf3{i}.addr2, address2)
        timestamps3to2 = [timestamps3to2; bf3{i}.timestamp_low];
        csi3to2 = [csi3to2; bf3{i}.csi(:,:,:)];
    end
end
